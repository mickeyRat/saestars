...
sub deleteRecordBy_PkCategoryIdx(){
	my ($self) = shift;
	my ($idx) = shift;
...
sub deleteRecordBy_InSegmentRef(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where IN_SEGMENT_REF=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InSection(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where IN_SECTION=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxTitle(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where TX_TITLE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxDetail(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where TX_DETAIL=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InMin(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where IN_MIN=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InMax(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where IN_MAX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InWeight(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where IN_WEIGHT=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InOrder(){
	...
	my $SQL = "DELETE FROM TB_CATEGORY where IN_ORDER=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
