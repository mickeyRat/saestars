...
sub deleteRecordBy_PkAssessmentReqIdx(){
	my ($self) = shift;
	my ($idx) = shift;
...
sub deleteRecordBy_FkAssessmentOptIdx(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where FK_ASSESSMENT_OPT_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxTitle(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where TX_TITLE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxDetail(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where TX_DETAIL=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InWeight(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where IN_WEIGHT=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InOrder(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where IN_ORDER=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}

sub deleteRecordBy_BoCheck(){
	my ($self) = shift;
	my ($idx) = shift;

	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where BO_CHECK=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}

sub deleteRecordBy_TxInputType(){
	my ($self) = shift;
	my ($idx) = shift;

	my $SQL = "DELETE FROM TB_ASSESSMENT_REQ where TX_INPUT_TYPE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
