...
sub deleteRecordBy_PkAssessmentTypeIdx(){
	my ($self) = shift;
	my ($idx) = shift;
...
sub deleteRecordBy_TxType(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_TYPE where TX_TYPE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxDetail(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_TYPE where TX_DETAIL=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InMax(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_TYPE where IN_MAX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InWeight(){
	...
	my $SQL = "DELETE FROM TB_ASSESSMENT_TYPE where IN_WEIGHT=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
