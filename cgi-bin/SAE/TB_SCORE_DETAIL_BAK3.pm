...
sub addNewRecord(){
	...
	my $SQL = "INSERT INTO TB_SCORE_DETAIL_BAK3 (FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND) values (?, ?, ?, ?, ?, ?, ?, ?)";
...
sub getAllRecordBy_PkScoreDetailIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE PK_SCORE_DETAIL_IDX=?";
	my $select = $dbi->prepare($SQL);
...
sub getAllRecordBy_FkAssessmentTypeIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE FK_ASSESSMENT_TYPE_IDX=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_FkAssessmentOptIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE FK_ASSESSMENT_OPT_IDX=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_FkAssessmentReqIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE FK_ASSESSMENT_REQ_IDX=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_FkTeamIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE FK_TEAM_IDX=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_FkUserIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE FK_USER_IDX=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_InValue(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE IN_VALUE=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_FkJudgeTeamIdx(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE FK_JUDGE_TEAM_IDX=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecordBy_InRound(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3 WHERE IN_ROUND=?";
	my $select = $dbi->prepare($SQL);
	   $select->execute($value);
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub getAllRecord(){
	...
	my $SQL = "SELECT PK_SCORE_DETAIL_IDX, FK_ASSESSMENT_TYPE_IDX, FK_ASSESSMENT_OPT_IDX, FK_ASSESSMENT_REQ_IDX, FK_TEAM_IDX, FK_USER_IDX, IN_VALUE, FK_JUDGE_TEAM_IDX, IN_ROUND FROM TB_SCORE_DETAIL_BAK3";
	my $select = $dbi->prepare($SQL);
	   $select->execute();
	my %HASH = %{$select->fetchall_hashref(['PK_SCORE_DETAIL_IDX'])};
	return(\%HASH);
...
sub deleteRecordById(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where PK_SCORE_DETAIL_IDX=?";
...
sub deleteRecordBy_FkAssessmentTypeIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where FK_ASSESSMENT_TYPE_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkAssessmentOptIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where FK_ASSESSMENT_OPT_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkAssessmentReqIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where FK_ASSESSMENT_REQ_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkTeamIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where FK_TEAM_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkUserIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where FK_USER_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InValue(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where IN_VALUE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkJudgeTeamIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where FK_JUDGE_TEAM_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InRound(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK3 where IN_ROUND=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub updatePkScoreDetailIdx_ById(){
	...
	my $SQL = "UPDATE TB_SCORE_DETAIL_BAK3 SET PK_SCORE_DETAIL_IDX=? where PK_SCORE_DETAIL_IDX = ?";
	my $update = $dbi->prepare($SQL);
	   $update->execute($value, $idx);
	return ();
}
