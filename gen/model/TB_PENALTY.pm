...
sub deleteRecordBy_PkPenaltyIdx(){
	my ($self) = shift;
	my ($idx) = shift;
...
sub deleteRecordBy_FkTeamIdx(){
	...
	my $SQL = "DELETE FROM TB_PENALTY where FK_TEAM_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxType(){
	...
	my $SQL = "DELETE FROM TB_PENALTY where TX_TYPE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}

sub deleteRecordBy_TxDetails(){
	my ($self) = shift;
	my ($idx) = shift;

	my $SQL = "DELETE FROM TB_PENALTY where TX_DETAILS=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InValue(){
	...
	my $SQL = "DELETE FROM TB_PENALTY where IN_VALUE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_TxCategory(){
	...
	my $SQL = "DELETE FROM TB_PENALTY where TX_CATEGORY=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
