...
sub deleteRecordBy_FkAssessmentTypeIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where FK_ASSESSMENT_TYPE_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkAssessmentOptIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where FK_ASSESSMENT_OPT_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkAssessmentReqIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where FK_ASSESSMENT_REQ_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkTeamIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where FK_TEAM_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkUserIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where FK_USER_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InValue(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where IN_VALUE=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_FkJudgeTeamIdx(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where FK_JUDGE_TEAM_IDX=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
...
sub deleteRecordBy_InRound(){
	...
	my $SQL = "DELETE FROM TB_SCORE_DETAIL_BAK2 where IN_ROUND=?";
	my $delete = $dbi->prepare($SQL);
	   $delete->execute($idx);
	return();
}
